...
export default function UkrainianHome() {
  return (
    <main>
      <nav className="nav">
        <a className="brand" href="/ua">IR</a>
        <div>
          <a href="/about">About</a><a href="/services">Services</a><a href="/case-studies">Case studies</a><a href="/cv">CV</a><a href="/northbridge">Northbridge</a>
          <span className="langSwitch"><a href="/">EN</a><a className="active" href="/ua">UA</a></span>
        </div>
      </nav>

      <section className="hero section">
        <div className="eyebrow">Critical Systems · Platform Reliability · FinTech/Web3 Risk</div>
        <h1>Іван Розінко допомагає командам стабілізувати критичні системи до того, як ризики стануть інцидентами, аудитом або втратою грошей.</h1>
        ...
        <div className="ctaRow">
          <a className="button primary" href="/services">Services</a>
      ...
      <section className="section grid two">
        <div>
          ...
          <h2>Не просто QA. Не просто DevOps. Не просто software або firmware.</h2>
          <p>Цінність — у cross-layer ownership: бачити, як код, інфраструктура, firmware, релізний процес, observability, тестування, payment logic та compliance працюють як єдина поверхня ризику.</p>
        </div>
        <div className="card">
          <h3>Core operating sentence</h3>
          <p>Я допомагаю fintech, Web3, SaaS, AI та regulated teams знижувати platform, delivery та operational risk across the full technical stack.</p>
        </div>
      </section>

      <section className="section">
        <div className="eyebrow">Experience map</div>
        <div className="chips">{experience.map((item) => <span key={item}>{item}</span>)}</div>
      </section>

      <section className="section">
        <div className="eyebrow">Advisory areas</div>
        <h2>Де я можу бути корисним</h2>
      ...
      <section className="section split">
        <div>
          ...
          <p>Компактний advisory engagement, який мапить ключові технічні та операційні ризики across architecture, platform, CI/CD, QA, monitoring, release process, incident readiness and business-critical flows.</p>
        </div>
        <div className="card accent">
          ...
          <ul>
            ...
            <li>Executive summary для CTO, founders або stakeholders</li>
          </ul>
        </div>
      </section>
      ...
      <section className="section">
        ...
        <div className="grid two">
          {repos.map(([title, text, url]) => <a className="card repo" href={url} target="_blank" rel="noreferrer" key={title}><h3>{title}</h3><p>{text}</p></a>)}
        </div>
      </section>
      ...
      <section className="section contact">
        <div>
          ...
          <p>Best fit: Principal / Staff / Head / Fractional CTO roles або advisory work у fintech, Web3, AI, SaaS, platform, embedded-to-cloud та regulated systems.</p>
        </div>
        <div className="ctaRow">
